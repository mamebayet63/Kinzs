                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($reservation["status"] == "attente"): ?>
                                                                    <a href="../../../controllers/admin/reservation/checkReservationController.php?id=<?= $reservation['ID_Reservation'] ?>" class="btn btn-success d-flex align-items-center gap-2 btn-sm">
                                                                        <span>Rendu(e)</span>
                                                                ...
                                                                <?php endif; ?>
                                                                <a data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $k ?>" class="btn-sm text-black">
                                                                    Details
                                                                </a>
                                                            </td>
                                                        </tr>
