...
<header style="position: fixed;top:0;z-index:1000;background-color:white;width:100%">
        ...
        <div class="container-fluid px-5">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 menu p-1 px-3 d-flex gap-0 monBag rounded-pill ">
                    <li class="nav-item">
                        <a class="nav-link sidebar-link monCouleur" href="chambre.php">Nos Chambres</a>
                    </li>
                    <li class="" style="width:320px">
                        <hr class="mt-4">
                    </li>
                    <li class="nav-item">
                        <a class="nav-link sidebar-link  monCoul2" href="propos.php">Qui sommes-nous ?</a>
                    </li>
                    <li class="nav-item">
    ...
    "></script>
    <script src="../../../public/javascript/propos.js"></script>
    <script
